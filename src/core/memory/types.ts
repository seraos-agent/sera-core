...
export type MemoryCategory = 'EPISODIC' | 'SEMANTIC' | 'PROCEDURAL' | 'RELATIONAL' | 'INTENT_REALIZATION' | 'OUTCOME_REALIZATION' | 'CALIBRATION' | 'GOVERNANCE_DECISION_RECORD' | 'GOVERNANCE_OUTCOME_RECORD' | 'GOVERNANCE_PATTERN_RECORD' | 'GOAL_INTELLIGENCE_RECORD' | 'GOAL_GRAPH_RECORD' | 'GOAL_TENSION_RECORD' | 'GOAL_DRIFT_RECORD' | 'GOAL_INTERPRETATION_RECORD' | 'SELF_MODEL_SNAPSHOT' | 'EXECUTION_POLICY_ADAPTATION' | 'REPUTATION';
